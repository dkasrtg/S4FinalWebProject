    ...
    <script src="<?= base_url('assetsClient/tricksjs/jquery.flot.min.js')?>"></script>
    <script src="<?= base_url('assetsClient/tricksjs/jquery.flot.pie.min.js')?>"></script>
    <script src="<?= base_url('assetsClient/tricksjs/jquery.flot.spline.min.js')?>"></script>
